...
static struct value *stabs_evaluate_address (struct type *type, void* locbaton,
					     struct value *obj, void* frame);

static struct value *stabs_evaluate_int (struct type *type, void* locbaton,
					 struct value *obj, void* frame);
...
stabs_create_generic_allocated_baton (struct type* type, struct stabs_alloc_baton* baton, struct type* range_type)
{
  ...
  generic_baton->evaluate_address = stabs_evaluate_address;
  generic_baton->evaluate_int = stabs_evaluate_int;
...
static struct value *
stabs_evaluate_address (struct type *type, void* locbaton,
			 struct value *obj, void* frame)
{
  (void) type;
  (void) locbaton;
  ...
  /* Stabs debugging format is not supported in this version of GDB, at
     least not to a point where this function is needed.  */
  error ("unsupported feature in function %s", __PRETTY_FUNCTION__);
}

static struct value *
stabs_evaluate_int (struct type *type, void* locbaton,
		    struct value *obj, void* frame)
{
  (void) type;
  (void) locbaton;
